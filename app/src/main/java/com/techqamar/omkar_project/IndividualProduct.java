...
//    EditText custommessage;
    ...
    private void initialize() {
        ...
        Picasso.get().load(model.getImageUrl()).fit().into(productimage);
...
//    }
    ...
    private SingleProductModel getProductObject() {
        ...
        return new SingleProductModel(model.getCardid(), Integer.parseInt(quantityProductPage.getText().toString()), useremail, usermobile, model.getCardname(), Float.toString(model.getCardprice()), model.getImageUrl(), model.carddiscription);
