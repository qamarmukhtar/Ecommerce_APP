package com.techqamar.omkar_project.models;
...
public class GenericProductModel implements Serializable {
    ...
    public GenericProductModel(int cardid, String cardname, String imageUrl, String carddiscription, float cardprice) {
        this.cardid = cardid;
