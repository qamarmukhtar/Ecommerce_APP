...
import com.techqamar.omkar_project.Cart;
import com.techqamar.omkar_project.IndividualProduct;
//import com.techqamar.omkar_project.NotificationActivity;
import com.techqamar.omkar_project.R;
import com.techqamar.omkar_project.models.GenericProductModel;
...
public class Cards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseRecyclerAdapter<GenericProductModel,MovieViewHolder> adapter = new FirebaseRecyclerAdapter<GenericProductModel, MovieViewHolder>(
            ...
            protected void populateViewHolder(final MovieViewHolder viewHolder, final GenericProductModel model, final int position) {
                ...
                viewHolder.cardisc.setText((model.getCarddiscription()));
                viewHolder.cardprice.setText("₹ "+Float.toString(model.getCardprice()));
                Picasso.get().load(model.getImageUrl()).fit().into(viewHolder.cardimage);
    ...
    public static class MovieViewHolder extends RecyclerView.ViewHolder{
        ...
        public MovieViewHolder(View v) {
            ...
            cardisc = v.findViewById(R.id.discription);
